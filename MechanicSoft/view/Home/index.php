 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <!-- Tabla Estatus Taller -->
         <section class="content">
         <div class="row mb-2">
            <div class="col-md-6">
                <div class="box">
                  <div class="box-header with-border">
                       <h3 class="box-title">Estatus Vehículos Taller</h3>
                  </div>
                  <!-- /.box-header -->
                 <div class="box-body">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Top 10 Clientes en Taller</h3>
...
<!-- jQuery UI 1.11.4 -->
<script src="../../AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/jquery-ui/jquery-ui.min.js"></script>
